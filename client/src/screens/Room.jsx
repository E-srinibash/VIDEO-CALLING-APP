...
const RoomPage = () => {
  ...
  const handleUserJoined = useCallback(({ email, id }) => {
    console.log(`Email ${email} joind room`);
  ...
  return (
    <div>
      ...
      {myStream &&( 
        <>
        <h1>My Stream</h1>
        <ReactPlayer heigth="100px" playing mute width="200px" url={myStream}/>
        </>
    )}
    {remoteStream &&( 
        <>
        <h1>Remote Stream</h1>
        <ReactPlayer heigth="100px" playing mute width="200px" url={remoteStream}/>
        </>
    )}
    </div>
  );
